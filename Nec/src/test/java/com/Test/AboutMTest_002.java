...
//	        loginTestInstance.ValidLogin();
		...
		// FactAtGlancePom FactAtGlanePg = PageFactory.initElements(driver,
		// FactAtGlancePom.class);
		Library.custom_waitForVisibility(driver, FactAtGlanePg.getMenuBtn2(), 20);
		Library.custom_click(FactAtGlanePg.getMenuBtn2(), "About");
		...
		Library.custom_sendKeys(ContactUsPg.getYourMsg(), ExcelDataProvider.getStringData("Sheet1", 0, 6),
				"Your Message");
...
//			LoginTest_001 loginTestInstance = new LoginTest_001();
//	        loginTestInstance.ValidLogin();
		// FestivalPagePom FestivalPg = PageFactory.initElements(driver,
		// FestivalPagePom.class);
